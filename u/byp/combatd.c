...
// add the quest reward here
	...
	&& killer->query("zhao_job/bonus") > 0 ) {
        	...
        	chinese_number(exp*factor) + "点实战经验\n"+
        	chinese_number(pot*factor) + "点潜能\n" +
        	chinese_number(score*factor)+"点江湖阅历。\n"NOR);
