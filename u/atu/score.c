...
int main(object me, string arg)
{
	...
	line+=HIG"≡"NOR"──────────────────────────────────"HIG"≡\n"NOR;
	line+=sprintf(
GRN"    【"WHT"才智"GRN"】"WHT"%s"GRN"      【"WHT"体质"GRN"】"WHT"%s"GRN"      【"WHT"灵性"GRN"】"WHT"%s\n"
GRN"    【"WHT"魅力"GRN"】"WHT"%s"GRN"      【"WHT"力量"GRN"】"WHT"%s"GRN"      【"WHT"勇气"GRN"】"WHT"%s\n"
GRN"    【"WHT"耐力"GRN"】"WHT"%s"GRN"      【"WHT"韧性"GRN"】"WHT"%s"GRN"      【"WHT"速度"GRN"】"WHT"%s\n"
GRN"    【"WHT"气量"GRN"】"WHT"%s"GRN"      【"WHT"运气"GRN"】"WHT"%s"GRN"      【"WHT"定力"GRN"】"WHT"%s\n"NOR,
...
if ((int)ob->query("shen")<0)
	...
	line +=sprintf(GRN"              【"WHT"参 数 点"GRN"】"WHT"%5d          "GRN"【"WHT"正    气"GRN"】"WHT"  %d\n"NOR,ob->query("gift_points") - 
                       ob->query("used_gift_points"),ob->query("shen"));
	line+="  ────────────────────────────────── \n";
	line +=sprintf(GRN"         【"WHT"开封府贡献"GRN"】"HIY"%6d              "NOR,ob->query("kf_worked"));
      	line +=sprintf(GRN" 【"WHT"大理国贡献"GRN"】"HIY" %d\n"NOR,ob->query("gongxian"));
	line+=HIG"≡"NOR"──────────────"HIR" ☆"HIY"世纪风云"HIR"☆ "NOR"─────────────"HIG"≡\n"NOR;
       write(line);
       return 1;
}
