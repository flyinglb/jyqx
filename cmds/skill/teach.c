...
inherit F_CLEAN_UP;
string* force_skill = ({
		"baihuang-gong", "beiming-shengong", "bibo-shengong",
		"bingxue-xinfa", "guiyuan-tunafa", "hamagong",
		"huagong-dafa", "huashan-neigong", "huntian-qigong",
		"hunyuan-yiqi", "kurong-changong", "kuihua-xinfa",
		"linji-zhuang", "longxiang", "jiuyang-shengong",
		"shenlong-xinfa", "shenyuan-gong", "taiji-shengong",
		"taixuan-gong", "wudu-shengong", "xiantian-qigong",
		"xiaowuxiang", "xuantian-force", "yijinjing", 
		"yunlong-shengong", "yunv-xinfa", "zixia-shengong",
});
...
int main(object me, string arg)
{
	...
	object ob;
	int student_skill, my_skill, gin_cost, grade, student_combat_exp, i;
	...
	for ( i=sizeof(force_skill); i>0; i-- )
	{
	if( my_skill == me->query_skill(force_skill[i-1],1))
		return notify_fail("你无法传授内功心法。\n");
	}
