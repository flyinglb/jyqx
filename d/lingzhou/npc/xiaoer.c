...
tell_object(ob,"店小二笑咪咪地说道：这位"+RANK_D->query_respect(ob)+"，欢迎来到"GRN"侠客行一百。"NOR"
...
是这里所有玩家都能用的命令。想认识一下这里的地图就"RED"help map"NOR"，里
面有很多项目的，你可以选择地图项目"RED"help map_all"NOR"看到整个游戏的地
图。而"RED"help map_yz "NOR"就是你现在呆的城市的地图。当然最重要的是向老
玩家请教，这就一定要会使用"RED"chat"NOR"这个命令啦。这里的帮助文件也因为
我们的工作而更新，多多留意哦。客店往西，南，西，西，南就到武馆
了，叛师在这里会吃亏的，所以没想好拜哪个门派就先去武馆学。扬州
的武庙是信息中心，常去看看那里的公告，最新的消息一定最早出现在
那里。
    如果您对这个游戏的设计和管理有什么建议或意见请"RED"mailto java"NOR"，
我们一定会认真考虑的。\n\n");
	}
	switch( random(2) ) {
		case 0:
