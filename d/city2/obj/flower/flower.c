...
void create()
{
  ...
  switch (random(14))
  {
    ...
    case 3:
      { set_name(HIR "野风信子" NOR, ({ "flower"})); break; }
    case 4:
      { set_name(HIW "玉白露" NOR, ({ "flower"})); break; }
    case 5:
      { set_name(HIW "睡芙蓉" NOR, ({ "flower"})); break; }
    case 6:
      { set_name(HIC "紫蔷薇" NOR, ({ "flower"})); break; }
    case 7:
      { set_name(HIR "大丽花" NOR, ({ "flower"})); break; }
    case 8:
      { set_name(HIM "勿忘我" NOR, ({ "flower"})); break; }
    case 9:
    ...
    case 13:
      { set_name(HIW "睡莲" NOR, ({ "flower"})); break; }
  }
  set_weight(100);
