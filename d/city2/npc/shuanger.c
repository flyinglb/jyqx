...
int accept_object(object me,object obj)
{
        ...
        if( !have )
        {
                ...
                {
                        if(id == host_id)
                                message_vision(WHT"$N向$n"WHT"福了福说道：“主人，双儿只会使剑啊。”\n"NOR,shuanger,me);
                        else
                                message_vision(WHT"$N向$n"WHT"福了福说道：“多谢这位"+RANK_D->query_respect(me)+"小女子只会使剑啊。”\n"NOR,shuanger,me);
                        return 0;
                }
                if(id == host_id)
                        message_vision(WHT"$N向$n"WHT"福了福说道：“多谢主人。”\n"NOR,shuanger,me);
                else
                        message_vision(WHT"$N向$n"WHT"福了福说道：“多谢这位"+RANK_D->query_respect(me)+"。”\n"NOR,shuanger,me);
                ...
                if(id == host_id)
                {
                        message_vision(WHT"$N向$n"WHT"福了福说道：“多谢主人的一片好意，双儿已经有兵刃了。”\n"NOR,shuanger,me);
                        return 0;
                }
                else
                {
                        message_vision(WHT"$N向$n"WHT"福了福说道：“多谢这位"+RANK_D->query_respect(me)+"的一片好意，小女子已经有兵刃了。”\n"NOR,shuanger,me);
                        return 0;
                }
}                        
