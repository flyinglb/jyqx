...
void create()
{
	set("short", "拇指峰");
	set("long", @LONG
    拇指峰是铁掌五峰中最为低矮的一峰，名为峰，实则只是一座较
高的石山罢了。峰顶到处是又大又圆的岩石，在日晒雨淋下，被风蚀得十
分光滑。在岩石的缝隙中，长出许多松树，其中一棵尤其引人注目。这棵
松名为--并蒂松(song)，乃同根而生，于距地一米高处，忽分为二。这两
根树干同粗同高，均长得高大挺拔，枝叶茂盛，尤如兄弟一般，因此又名
--兄弟松。
LONG	);
	set("exits", ([ /* sizeof() == 1 */
